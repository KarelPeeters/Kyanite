...
fn profile_conv(batch_size: usize, input_channels: usize, output_channels: usize, io_size: usize, kernel_size: usize) -> f32 {
    ...
    let mut exec = CudnnExecutor::new(device, &graph, batch_size);
